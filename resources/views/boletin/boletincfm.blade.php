...
<body>
     <div id="watermark">
        ...
        <div id="contenido" class="contenido">
            ...
            <p style=" top: 104px;left: 278px; height:15px; width:90px;  text-align: center;  position: absolute;font-weight: bold;font-size: 12px; color:black; background:none; ">6°CFM</p>
